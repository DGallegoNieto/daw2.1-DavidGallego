...
//Está toodo correcto de forma normal si NO ha habido errores y se ha visto afectada UNA fila.
...
<?php } else if ($no_existia) { ?>
    ...
    <p>No existe el contacto que se pretende eliminar (¿ha manipulado Vd. el parámetro id?).</p>
